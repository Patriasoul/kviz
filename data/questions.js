/* PatriaSoul Quiz – centralna banka pitanja. Izvori 800 + 1200 ostaju neizmijenjeni. */
(function () {
  const sources = [
    'https://cdn.jsdelivr.net/gh/Patriasoul/patriasoul@main/question_banks_800.js',
    'https://cdn.jsdelivr.net/gh/Patriasoul/patriasoul@main/question_banks_1200.js'
  ];
  ...
  window.PATRIA_SOUL_QUESTION_META = {
    imported800and1200: imported.length,
    total: window.PATRIA_SOUL_QUESTIONS.length,
    categories: [...new Set(window.PATRIA_SOUL_QUESTIONS.map(q => q.category))]
  };
})();
