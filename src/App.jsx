...
export default function App() {
  ...
  return <div className="min-h-screen bg-background text-foreground">
    ...
    <div className="patria-portal-bar"><div className="mx-auto flex max-w-[1400px] items-center justify-between gap-4 px-4 py-3 sm:px-6"><div className="text-sm text-white/70">PatriaSoul Kviz - Hrvatska · povijest · znanje · identitet</div><a href="https://patriasoul.github.io/" className="patria-portal-button" aria-label="Povratak na PatriaSoul portal"><ArrowLeft className="h-5 w-5" /> Povratak na PatriaSoul portal</a></div></div>
